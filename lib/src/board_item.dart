...
class BoardItemState extends State<BoardItem>
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        ...
        onLongPress: () {
          isShakeItem = !isShakeItem;
          setState(() {});
          debugPrint('onTap: =================> $isShakeItem');
        ...
        //   child: widget.item ?? const SizedBox(),
        // ),
        );
  }
}
